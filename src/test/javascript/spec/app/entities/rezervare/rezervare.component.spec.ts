...
import { RezervareComponent } from 'app/entities/rezervare/rezervare.component';
...
describe('Component Tests', () => {
  describe('Rezervare Management Component', () => {
    let comp: RezervareComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(RezervareComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.rezervares && comp.rezervares[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
