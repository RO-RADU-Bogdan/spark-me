...
import { LocatieComponent } from 'app/entities/locatie/locatie.component';
import { LocatieService } from 'app/entities/locatie/locatie.service';
import { Locatie } from 'app/shared/model/locatie.model';

describe('Component Tests', () => {
  describe('Locatie Management Component', () => {
    let comp: LocatieComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(LocatieComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.locaties && comp.locaties[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
