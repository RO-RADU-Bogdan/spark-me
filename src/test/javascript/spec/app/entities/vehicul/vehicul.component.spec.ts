...
import { VehiculComponent } from 'app/entities/vehicul/vehicul.component';
import { VehiculService } from 'app/entities/vehicul/vehicul.service';
import { Vehicul } from 'app/shared/model/vehicul.model';

describe('Component Tests', () => {
  describe('Vehicul Management Component', () => {
    let comp: VehiculComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(VehiculComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.vehiculs && comp.vehiculs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
